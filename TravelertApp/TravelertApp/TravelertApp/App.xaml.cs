    ...
    public partial class App : Application
    {
        ...
        public App()
        {
            ...
            try
            {
                ...
                if (ConsumersLoginViewModel.IsLoggedIn) //if the user is signed in
                {
                    MainPage = new NavigationPage(new ConsumerTabbedPage(ConsumerUID));
                    //if (RegisterPage.userRole == "Consumer") //if the user is a consumer
                    //{
                    //    MainPage = new NavigationPage(new GeneralPublicPage());
                    //}
                    //else if (RegisterPage.userRole == "Entrepreneur") //else if the user is an entrepreneur
                    //{
